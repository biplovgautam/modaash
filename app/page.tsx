...
const plans = [
  {
    ...
    features: ["Up to 100 workers", "Analytics", "Priority support", "Unlimited documents", "BS calendar", "Sub-agent management", "Real-time notifications"],
    popular: false,
  ...
  },
  {
    ...
    features: ["Unlimited workers", "Custom advance analytics", "Dedicated account manager", "API access", "Custom integrations", "On-premise option", "SLA guarantee"],
    popular: true,
